...
public class DescribeMinuteStrategy implements CronDescribeStrategy {
    ...
    public String describe(CronFieldValue cronFieldValue) {
        ...
        switch (cronFieldValue.getExpressionType()) {
            ...
            case INTERVAL:
                ...
                for (int i = startValue; i < 60; i += intervalsDuration) {
                    builder.append(i + " ");
                }
                break;
            case SPECIFIC:
                ...
                for (int i = 0; i < specifics.length; i++) {
                    builder.append(Integer.valueOf(specifics[i]) + " ");
                }
                break;
        }
