...
public class DayOfWeekExpressionValidatorTest {

    private CronExpressionValidator dayOfWeekExpressionValidator = new HourExpressionValidator(CronConfig.DAY_OF_WEEK_RANGE, CronConfig.DAY_OF_WEEK_POSITION);

    private static String[] getExpression(String exp) {
        String[] expressions = new String[CronConfig.VALID_CRON_LENGTH];
        expressions[CronConfig.DAY_OF_WEEK_POSITION] = exp;
        return expressions;
    }
    ...
    public void validate_whenExpressionIsWildCard() {
        ...
        Assertions.assertDoesNotThrow(() -> dayOfWeekExpressionValidator.validate(cronExpression));
    }
    ...
    public void validate_whenExpressionIsNumberAndOutOfUpperRange() {
        ...
        String[] expressions = getExpression(exp);
        CronExpressionDto cronExpression = new CronExpressionDto(expressions);
        Assertions.assertThrows(InvalidExpressionException.class, () -> dayOfWeekExpressionValidator.validate(cronExpression));
    }
