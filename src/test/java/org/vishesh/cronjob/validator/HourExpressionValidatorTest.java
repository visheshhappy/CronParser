...
public class HourExpressionValidatorTest {

    private CronExpressionValidator hourExpressionValidator = new HourExpressionValidator(CronConfig.HOUR_RANGE, CronConfig.HOUR_POSITION);

    private static String[] getExpression(String exp) {
        String[] expressions = new String[CronConfig.VALID_CRON_LENGTH];
        expressions[CronConfig.HOUR_POSITION] = exp;
        return expressions;
    }
    ...
    public void validate_whenExpressionIsWildCard() {
        ...
        Assertions.assertDoesNotThrow(() -> hourExpressionValidator.validate(cronExpression));
    }
    ...
    public void validate_whenExpressionIsNumberAndOutOfUpperRange() {
        ...
        map.put(CronFieldName.MINUTE, new CronFieldValue(CronFieldName.MINUTE, exp, CronFieldValue.ExpressionType.ALWAYS));
        CronExpressionDto cronExpression = new CronExpressionDto(expressions);
        Assertions.assertThrows(InvalidExpressionException.class, () -> hourExpressionValidator.validate(cronExpression));
    }
